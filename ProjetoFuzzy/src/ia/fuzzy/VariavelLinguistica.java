...
public class VariavelLinguistica {
    ...
    private void inicializarConjuntos()
    {
        if (nome.equals("Temperatura")) {//estou colocando zero onde não tem valor
            conjuntos.add(new ConjuntoFuzzy(this, "baixa", "trapezoidal", 0, 1000, 800, 900));
            conjuntos.add(new ConjuntoFuzzy(this, "media", "triangular", 900, 1100, 1000, 0));
            conjuntos.add(new ConjuntoFuzzy(this, "alta", "trapezoidal", 1000, 0, 1100, 1200));
        }
        else if(nome.equals("Volume")) {
            conjuntos.add(new ConjuntoFuzzy(this, "pequeno","trapezoidal", 0, 7, 2, 4.5));
            conjuntos.add(new ConjuntoFuzzy(this, "medio", "triangular", 4.5, 9.5, 7, 0));
            conjuntos.add(new ConjuntoFuzzy(this, "grande","trapezoidal", 7, 0, 9.5, 12));
        }
        else if(nome.equals("Pressao")) {
            conjuntos.add(new ConjuntoFuzzy(this, "baixa", "trapezoidal", 0, 8, 4, 5));
            conjuntos.add(new ConjuntoFuzzy(this, "media","triangular", 6, 10, 8, 0));
            conjuntos.add(new ConjuntoFuzzy(this, "alta", "trapezoidal", 8, 0, 11, 12));
        }
    }
